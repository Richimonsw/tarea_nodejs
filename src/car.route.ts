...
import {
  ...
  deleteCarro,
  updateCarro,
} from "./controller/controller.carro";
 ...
 */
router.get("/cars/:id", retrieveCarro);
 ...
 *
 */
router.delete("/cars/:id", deleteCarro);
 ...
 *
 */
router.put("/cars/:id", updateCarro);
