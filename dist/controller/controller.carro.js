...
const carro_model_1 = require("../models/carro.model");
...
const listCarro = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield new CarroController().list();
    return res.status(response.status).json(response);
});
...
class CarroController {
    create(carroContent) {
        return __awaiter(this, void 0, void 0, function* () {
            const carro = new carro_model_1.Carro(carroContent);
    ...
    retrieve(docId) {
        return __awaiter(this, void 0, void 0, function* () {
            return carro_model_1.Carro.findOne({ _id: docId }).then((data) => {
                if (data === null) {
                    return {
    ...
    delete(docId) {
        return __awaiter(this, void 0, void 0, function* () {
            return carro_model_1.Carro.deleteOne({ _id: docId }).then((data) => {
    ...
    list() {
        return __awaiter(this, void 0, void 0, function* () {
            return carro_model_1.Carro.find({}).then(data => {
                return {
    ...
    update(docId, carroContent) {
        return __awaiter(this, void 0, void 0, function* () {
            return carro_model_1.Carro.updateOne({ _id: docId }, { $set: {
